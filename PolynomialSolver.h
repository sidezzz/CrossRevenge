...
{
public:
	static int SolveQuadratic(float a, float b, float c, std::vector<double>& Sol);
	static int SolveCubic(float a, float b, float c, float d, std::vector<double>& Sol);
	static int SolveQuartic(float a, float b, float c, float d, float e, std::vector<double>& Sol);
};
